...
- (UIView *)backgroundView {
    if (!_backgroundView) {
        ...
        _backgroundView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.40];
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.layer.borderColor = Color_Text_Gray.CGColor;
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.backgroundColor = Color_Theme;
